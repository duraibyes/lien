        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    {{-- <li><a href="{{ route('job.request.list') }}"><i class="fa fa-building-o"></i> Job Request</a>
            </li> --}}
        ...
        <li>
            ...
            <li>
                <a href="{{ route('excel.upload.form') }}">
                    ...
                    <i class="fa fa-upload"></i> <span>Excel Upload</span>
             ...
             <li>
                <a href="{{ route('admin.permissions') }}">
                    ...
                    <i class="fa fa-upload"></i> <span>Permissions</span>
