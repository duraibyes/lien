                            ...
                            <div class="box-tools">
                                <div class="input-group input-group-sm" style="width: 150px;">
                                    <input type="text" id="state_search"
                                        value="<?php echo e(isset($_GET['stateSearch']) && $_GET['stateSearch'] != '' ? $_GET['stateSearch'] : ''); ?>"
                                ...
                                <?php if(count($states) > 0): ?>
                                    <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($state->short_code); ?></td>
                                            <td>
                                                <button class="btn btn-info btn-xs editState" type="button"
                                                    data-name="<?php echo e($state->name); ?>" data-code="<?php echo e($state->code); ?>"
                                                    data-short_code="<?php echo e($state->short_code); ?>"
                                                    data-id="<?php echo e($state->id); ?>" title="Edit user"><i
                                                        class="fa fa-pencil"></i></button>
                                                <button class="btn btn-danger btn-xs deleteState"
                                                    data-id="<?php echo e($state->id); ?>" type="button" title="Delete user"><i
    ...
    <script>
        $(document).ready(function() {
            $('#addStateButton').on('click', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('add.state')); ?>",
                    data: {
                        state: state,
                        code: code,
            ...
            $('.deleteState').on('click', function() {
                ...
                swal({
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(route('delete.state')); ?>",
                        data: {
                            id: id,
                            _token: '<?php echo e(csrf_token()); ?>'
                        },
            ...
            $('#editStateButton').on('click', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('edit.state')); ?>",
                    data: {
                        id: id,
                        state: state,
                        code: code,
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/lienmanager/public_html/resources/views/state/list.blade.php ENDPATH**/ ?>