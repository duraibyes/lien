...
<?php $__env->startSection('title', 'Remedy'); ?>
                    ...
                    <div class="box">
                            ...
                            <div class="box-tools">
                                <div class="input-group input-group-sm" style="width: 150px;">
                                    <input type="text" id="remedy_search"
                                        value="<?php echo e(isset($_GET['remedySearch']) && $_GET['remedySearch'] != '' ? $_GET['remedySearch'] : ''); ?>"
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-striped">
                                ...
                                <?php if(count($tierRemedySteps) > 0): ?>
                                    <?php $__currentLoopData = $tierRemedySteps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $tierRemedyStep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($key + 1); ?></td>
                                            <td><?php echo e($tierRemedyStep->tier->tier_code); ?></td>
                                            <td><?php echo e($tierRemedyStep->remedy_step->getRemedy->state->name); ?></td>
                                            <td><?php echo e($tierRemedyStep->remedy_step->getRemedy->type->project_type); ?></td>
                                            <td><?php echo e($tierRemedyStep->remedy_step->short_description); ?></td>
                                            <td><?php echo e($tierRemedyStep->answer1); ?></td>
                                            <td>
                                                <?php echo e($tierRemedyStep->answer2); ?>
                        ...
                        <div class="box-footer clearfix">
                            <ul class="pagination pagination-sm no-margin pull-right">
                                <?php echo e($tierRemedySteps->appends(Request::except('page'))->links()); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/lienmanager/public_html/resources/views/remedy/tier_remedy_step.blade.php ENDPATH**/ ?>