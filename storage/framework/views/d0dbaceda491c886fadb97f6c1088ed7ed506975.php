...
<?php $__env->startSection('title', 'Project customer'); ?>
                            ...
                            <div class="box-tools">
                                <div class="input-group input-group-sm" style="width: 150px;">
                                    <input type="text" id="tier_search"
                                        value="<?php echo e(isset($_GET['projectTier']) && $_GET['projectTier'] != '' ? $_GET['projectTier'] : ''); ?>"
                                ...
                                <?php if(count($tiers) > 0): ?>
                                    <?php $__currentLoopData = $tiers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $tier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($tier->role->project_roles); ?></td>
                                            <td><?php echo e($tier->customer->name); ?></td>
                                            <td>
                                                <?php echo e($tier->tier_code); ?>

                                            </td>
                                            <td>
                                                <?php echo e($tier->tier_limit); ?>

                                            </td>
                                            <td>
                                                <button class="btn btn-info btn-xs addTier"
                                                    data-role="<?php echo e($tier->role_id); ?>"
                                                    data-limit="<?php echo e($tier->tier_limit); ?>"
                                                    data-code="<?php echo e($tier->tier_code); ?>" data-id="<?php echo e($tier->id); ?>"
                                                    data-type="edit" type="button" title="Edit Tier"><i
                                                        class="fa fa-pencil"></i>
                                                </button>
                                                <button class="btn btn-danger btn-xs delete" type="button" data-type="tier"
                                                    data-id="<?php echo e($tier->id); ?>" title="Delete Tier">
                                ...
                                <div class="col-sm-8">
                                    <select name="role_id" id="role_id" class="form-control error">
                                        ...
                                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($role->id); ?>"><?php echo e($role->project_roles); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/lienmanager/public_html/resources/views/project/customer.blade.php ENDPATH**/ ?>