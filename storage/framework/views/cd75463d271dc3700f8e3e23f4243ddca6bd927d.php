        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input class="form-control error" type="text" name="company" id="company1" value="<?php echo e(!is_null($user->details) && !is_null($user->details->getCompany) && isset($user->details->getCompany->company) ? $user->details->getCompany->company : ''); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                                <textarea name="address" class="form-control error" placeholder="Enter Address"
                                          id="address1"><?php echo e(!is_null($user->details) && !is_null($user->details->getCompany) && isset($user->details->getCompany->address)? $user->details->getCompany->address : ''); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input class="form-control error" type="text" name="city" id="city1" value="<?php echo e(!is_null($user->details) && !is_null($user->details->getCompany) && isset($user->details->getCompany->city)? $user->details->getCompany->city : ''); ?>"
                        ...
                        <div class="col-md-8">
                            <select class="form-control error" name="state" id="state1" autocomplete="off">
                                ...
                                <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>" <?php echo e(!is_null($user->details) && !is_null($user->details->getCompany) && isset($user->details->getCompany->state_id) && $key == $user->details->getCompany->state_id ?  'selected' : ''); ?>><?php echo e($state); ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input class="form-control error" type="text" name="zip" id="zip1" value="<?php echo e(!is_null($user->details) && !is_null($user->details->getCompany) && isset($user->details->getCompany->zip)? $user->details->getCompany->zip : ''); ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input class="form-control error" type="text" name="phone" id="phone1" value="<?php echo e(!is_null($user->details) && !is_null($user->details->getCompany) && isset($user->details->getCompany->phone)? $user->details->getCompany->phone : ''); ?>"
                    ...
                    <input type="hidden" value="<?php echo e(!is_null($user->details) && !is_null($user->details->getCompany) && isset($user->details->getCompany->id) ?  $user->details->getCompany->id : 0); ?>" id="companyId">
...
</div><?php /**PATH /home2/lienmanager/public_html/resources/views/basicUser/modals/sub_user_modal.blade.php ENDPATH**/ ?>