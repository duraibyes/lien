...
<?php $__env->startSection('content'); ?>
                        ...
                        <div class="table-top">
                            <div class="flex items-center">
                                ...
                                <?php if(!$mobile): ?>
                                    <?php if(session()->has('express')): ?>
                                        <a href="<?php echo e(route('member.create.express.project')); ?>" title="Create A Project" class="orange-btn" style="background-color: #1083FF !important;">Add New Project</a>
                                    <?php else: ?>
                                        <a href="<?php echo e(route('member.create.project')); ?>" title="Create A Project" class="orange-btn" style="background-color: #1083FF !important;">Add New Project</a>
                                    <?php endif; ?>
                                <?php endif; ?>
                            ...
                            <div class="table-middle">
                                <div class="options-wrapper">
                                    <?php if(!$mobile && ! session()->has('express')): ?>
                                        ...
                                        <tr>
                                            <?php if(! session()->has('express')): ?>
                                                <th class="head-sort column_1" data-col="id"
                                                    data-type="<?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'id' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'DESC' : 'ASC'); ?>">
                                                    ID
                                                    <i class="fa-large fa <?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'id' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'fa-sort-desc' : 'fa-sort-asc'); ?>"
                                                        aria-hidden="true"></i>
                                                </th>
                                            <?php endif; ?>
                                            <?php if(! session()->has('express')): ?>
                                                <th class="head-sort column_2" data-col="customer_name"
                                                    data-type="<?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'customer_name' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'DESC' : 'ASC'); ?>">
                                                    Customer Name
                                                    <i class="fa-large fa <?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'customer_name' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'fa-sort-desc' : 'fa-sort-asc'); ?>"
                                                        aria-hidden="true"></i>
                                                </th>

                                                <th class="head-sort column_3" data-col="customer_company_name"
                                                    data-type="<?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'customer_company_name' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'DESC' : 'ASC'); ?>">
                                                    Contact
                                                    <i class="fa-large fa <?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'customer_company_name' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'fa-sort-desc' : 'fa-sort-asc'); ?>"
                                                        aria-hidden="true"></i>
                                                </th>
                                            <?php endif; ?>

                                            <th class="head-sort column_5" data-col="project_name"
                                                data-type="<?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'project_name' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'DESC' : 'ASC'); ?>">
                                                Project Name
                                                <i class="fa-large fa <?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'project_name' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'fa-sort-desc' : 'fa-sort-asc'); ?>"
                                                    aria-hidden="true"></i>
                                            </th>

                                            <?php if(! session()->has('express')): ?>
                                                <th class="head-sort column_4" data-col="customer_phone_number"
                                                    data-type="<?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'customer_phone_number' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'DESC' : 'ASC'); ?>">
                                                    Phone number
                                                    <i class="fa-large fa <?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'customer_phone_number' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'fa-sort-desc' : 'fa-sort-asc'); ?>"
                                                        aria-hidden="true"></i>
                                                </th>
												 <?php endif; ?>
                                                <th class="head-sort column_14" data-col="project_state"
                                                    data-type="<?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'project_state' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'DESC' : 'ASC'); ?>">
                                                    State
                                                    <i class="fa-large fa <?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'project_state' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'fa-sort-desc' : 'fa-sort-asc'); ?>"
                                                        aria-hidden="true"></i>
                                                </th>
												<?php if(! session()->has('express')): ?>
                                                <th class="head-sort column_16" data-col="job_address"
                                                    data-type="<?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'job_address' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'DESC' : 'ASC'); ?>">
                                                    Address
                                                    <i class="fa-large fa <?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'job_address' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'fa-sort-desc' : 'fa-sort-asc'); ?>"
                                                        aria-hidden="true"></i>
                                                </th>


                                            <th class="head-sort column_6" data-col="unpaid_balance"
                                                data-type="<?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'unpaid_balance' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'DESC' : 'ASC'); ?>">
                                                Unpaid Balance
                                                <i class="fa-large fa <?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'unpaid_balance' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'fa-sort-desc' : 'fa-sort-asc'); ?>"
                                                    aria-hidden="true"></i>
                                            </th>
											<?php endif; ?>
                                            ...
                                            <?php if(!$mobile): ?>
                                                <?php if(! session()->has('express')): ?>
                                                    <th class="head-sort column_7" data-col="status"
                                                        data-type="<?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'status' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'DESC' : 'ASC'); ?>">
                                                        Status
                                                        <i class="fa-large fa <?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'status' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'fa-sort-desc' : 'fa-sort-asc'); ?>"
                                                            aria-hidden="true"></i>
                                                    </th>
                                                    ...
                                                    <th class="head-sort column_9" data-col="updated_at"
                                                        data-type="<?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'updated_at' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'DESC' : 'ASC'); ?>">
                                                        Updated On
                                                        <i class="fa-large fa <?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'updated_at' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'fa-sort-desc' : 'fa-sort-asc'); ?>"
                                                            aria-hidden="true"></i>
                                                    </th>

                                                    <th class="head-sort column_10" data-col="created_at"
                                                        data-type="<?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'created_at' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'DESC' : 'ASC'); ?>">
                                                        Entry Date
                                                        <i class="fa-large fa <?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'created_at' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'fa-sort-desc' : 'fa-sort-asc'); ?>"
                                                            aria-hidden="true"></i>
                                                    </th>
                                                <?php endif; ?>
												 <?php if(! session()->has('express')): ?>
                                                <th class="head-sort column_15" data-col="" data-type="">
                                                    ...
                                                    <th class="head-sort column_13" data-col="project_documents"
                                                        data-type="<?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'project_documents' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'DESC' : 'ASC'); ?>">
                                                        Project Documents
                                                        <i class="fa-large fa <?php echo e(isset($_GET['sortWith']) && $_GET['sortWith'] == 'project_documents' && isset($_GET['sortBy']) && $_GET['sortBy'] == 'ASC' ? 'fa-sort-desc' : 'fa-sort-asc'); ?>"
                                                            aria-hidden="true"></i>
                                                    </th>
                                                    ...
                                                    <?php if(!$mobile): ?>
                                                        <?php if(! session()->has('express')): ?>
                                                            <td class="column_2">
                                                                <?php if($company != 'N/A'): ?>
                                                                    <a
                                                                        href="<?php echo e(route('member.create.projectcontacts', [$project->id]) . '?edit=true'); ?>">
                                                                        <?php echo e($company); ?>
                                                        ...
                                                        <?php if($mobile): ?>
                                                            <td class="column_5">
                                                                <a href="<?php echo e(route('member.view.projectMobile', [$project->id])); ?>"
                                                                    title="Open Project"><?php echo e(substr($project->project_name, 0, 20)); ?></a>
                                                            </td>
                                                        <?php else: ?>
                                                            <td class="column_5">
                                                                <a href="<?php echo e(route('member.create.edit.jobdescription', [$project->id]) . '?project_id=' . $project->id . '&edit=true'); ?>"
                                                                    title="Open Project"><?php echo e(substr($project->project_name, 0, 20)); ?>
                                                        ...
                                                        <?php if(! session()->has('express')): ?>
                                                            <td class="column_4">
                                                                <?php if($phone_number != 'N/A'): ?>
                                                                    <a
                                                                        href="tel:<?php echo e($phone_number); ?>"><?php echo e($phone_number); ?></a>
                                                                <?php else: ?>
														...
														<?php if(! session()->has('express')): ?>
                                                            <td class="column_16">
                                                                <a
                                                                    href="<?php echo e(route('member.create.edit.jobdescription', [$project->id]) . '?project_id=' . $project->id . '&edit=true'); ?>">

                                                                    <?php echo e($project->address . ' ' . $project->city); ?>
                                                        ...
                                                        <td class="column_6">
                                                            <a
                                                                href="<?php echo e(route('project.contract.view') . '?project_id=' . $project->id . '&edit=true'); ?>">
                                                                <?php echo e($project->unpaid_balance); ?>
													...
													<?php endif; ?>
                                                        <?php if(! session()->has('express')): ?>
                                                            ...
                                                            <td class="column_8">
                                                                ...
                                                                ?>
                                                                <?php if(isset($project->lienProviderByState) && !empty($project->lienProviderByState)): ?>
                                                                    <?php if(isset($lienProviderArray) && !empty($lienProviderArray) ): ?>
                                                                        <button class="btn btn-warning btn-sm viewProvider"
                                                                            data-provider="<?php echo $lienProviderArray; ?>"
                                                                            type="button" title="View Lien Provider">
                                                                            <i class="fa fa-eye"></i>
                                                                        </button>
                                                                    <?php else: ?>
                                                                        <?php echo e((isset($project->lienProviderByState[0]->company) ? $project->lienProviderByState[0]->company : 'N/A') . ' ( ' . $project->lienProviderByState[0]->firstName . ' ' . $project->lienProviderByState[0]->lastName . ' )'); ?>
                                                        ...
                                                        ?>
														 <?php if(! session()->has('express')): ?>
                                                        <td class="column_12">
                                                            <?php if(count($project->project_date) > 0): ?>
                                                                <a
                                                                    href="<?php echo e(route('create.deadlines', [$project->id]) . '?edit=true'); ?>">Deadlines</a>
                                                                 <a href="<?php echo e(route('create.deadlines', [$project->id]). '?edit=true'); ?>"><?php echo e($project['preliminaryDates']); ?> <br/> <?php echo e($project['preliminaryDatesName']); ?></a>
                                                            <?php else: ?>
                                                                <?php echo e('N/A'); ?>
                                                            ...
                                                            <td class="column_15">
                                                                <a
                                                                    href="<?php echo e(route('project.task.view') . '/' . $project->id . '?edit=true'); ?>">
                                                                    TASKS<br/>
                                                                    <?php echo e($project['nextTaskAction']); ?> <br/> <?php echo e($project['nextTaskDate']); ?>
                                                            ...
                                                            <td class="column_13">
                                                                <a
                                                                    href="<?php echo e(route('get.project.documents', [$project->id]) . '?edit=true'); ?>">Project
                                                                    Documents</a>
                                                            </td>
                                                                <td class="column_14">
                                                                    <?php echo e($project->username); ?>
                                                        ...
                                                        <td class="column_11">
                                                            ...
                                                            <a
                                                                href="<?php echo e(route('member.create.project') . '?project_id=' . $project->id . '&edit=true'); ?>">VIEW
                                                                / EDIT</a>
                                                            
                                                            | <a data-id="<?php echo e($project->id); ?>" class="deleteProject"
                                                                href="#">DELETE</a>
                                                        </td>
														<?php endif; ?>
                                                    <?php endif; ?>
                            ...
                            <!--<div class="imageBanner" style="margin-bottom: 40px;">
                                <a href="https://lienmanager.com/consultation/" target="_blank">
                                    <img src="<?php echo e(asset('images/dashimage.jpeg')); ?>" style="width:100%" />
                                </a>
                            </div>-->

                            <?php echo $__env->make('basicUser.projects.project_list_filter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
							 <?php endif; ?>
    ...
    <!--<div class="card-grid">
        <div class="card-row">
            <div class="card">
                <a href="#">
                    <img src="<?php echo e(asset('images/files-card.png')); ?>" alt="Card" />
                    <span>File Your Claim</span>
                </a>
            </div>
            <div class="card">
                <a href="#">
                    <img src="<?php echo e(asset('images/money-card.png')); ?>" alt="Card" />
                    <span>Collect Receivables</span>
                </a>
            </div>
            <div class="card">
                <a href="#">
                    <img src="<?php echo e(asset('images/consulting-card.png')); ?>" alt="Card" />
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        function savecoumn(str) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('user.columnAdd')); ?>",
                data: {
                    userid: userid,
                    columns: str,
                    _token: "<?php echo e(csrf_token()); ?>"
        ...
        let url = "<?php echo e(route('member.dashboard')); ?>"
...
<?php echo $__env->make('basicUser.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/lienmanager/public_html/resources/views/basicUser/dashboard/dashboard.blade.php ENDPATH**/ ?>