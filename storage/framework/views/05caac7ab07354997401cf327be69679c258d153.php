...
<?php $__env->startSection('body'); ?>
    ...
    <div class="">
        <div class="row">
            ...
            <?php if(isset($_GET['view']) && $_GET['view'] === 'detailed'): ?>
                <form method="post" action="<?php echo e(route('save.owner.notice', ['view' => 'detailed'])); ?>"
                ...
                <?php elseif(!isset($_GET['view']) && isset($_GET['create']) && $_GET['create'] === 'true'): ?>
                    <form method="post" action="<?php echo e(route('save.owner.notice', ['view' => 'express'])); ?>"
                        class="form-horizontal create-project-form create-project-form--wide">
                    <?php else: ?>
                        <form method="post" action="<?php echo e(route('save.owner.notice')); ?>"
                            class="form-horizontal create-project-form create-project-form--wide">
            <?php endif; ?>
                        ...
                        <div class="col-md-6 col-sm-12 formTable">
                            <div class="job-info-panel-input-wrapper">
                                ...
                                <input disabled type="text" name="company_name" id="company_name"
                                    value="<?php echo e($user->details ? ($user->details->getCompany ? $user->details->getCompany->company : '') : ''); ?>">
                            </div>
                                ...
                                <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($state->id === $user->details->state_id): ?>
                                        <input type="text" disabled
                                            value="<?php echo e($user->details && $user->details->state_id == $state->id ? $state->name : ''); ?>">
                                    <?php endif; ?>
                    ...
                    <div class="row">
                        ...
                        <span class="gc_show" id="show_general_contractor"
                            ...
                            <div class="col-md-6 col-sm-12 formTable">
                                ...
                                <div class="job-info-panel-input-wrapper">
                                    ...
                                    <input type="text" name="customer_address" readonly
                                        value="<?php echo e($project->customer_contract ? $project->customer_contract->contactsAd->address : ''); ?>">
                                </div>
                                <div class="job-info-panel-input-wrapper">
                                    <label for="customer_city">City</label>
                                    <input type="text" name="customer_city" readonly
                                        value="<?php echo e($project->customer_contract ? $project->customer_contract->contactsAd->city : ''); ?>">
                                </div>
                                <div class="job-info-panel-input-wrapper">
                                    <label for="job_state">State</label>
                                    <?php if(!empty($project->customer_contract->company->state_id)): ?>
                                        <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($state->id === $project->customer_contract->company->state_id): ?>
                                                <input type="text" value="<?php echo e($state->name); ?>" disabled>
                                            <?php endif; ?>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php else: ?>
                                ...
                                <div class="job-info-panel-input-wrapper">
                                    ...
                                    <input type="text" name="customer_zip" readonly
                                        value="<?php echo e($project->customer_contract ? $project->customer_contract->contactsAd->zip : ''); ?>">
                                </div>
                                <?php
                                ...
                                <div class="job-info-panel-input-wrapper">
                                    ...
                                    <input type="text" name="customer_fax" readonly
                                        value="<?php echo e($project->customer_contract ? $project->customer_contract->contactsAd->fax : ''); ?>">
                                </div>
                                <div class="job-info-panel-input-wrapper">
                            ...
                            <div class="col-md-6 col-sm-12 formTable">
                                ...
                                <div class="row"
                                    style="display: <?php echo e(isset($jobInfoSheet) && $jobInfoSheet != '' && $jobInfoSheet->status == '2' ? 'block' : 'block'); ?>;">
                                    <div class="col-md-12">
                                        <?php if(!is_null($project->customer_contract)): ?>
                                            <input type="button" value="Edit Contact"
                                                ...
                                                data-company_id="<?php echo e($project->customer_contract ? $project->customer_contract->company_id : '0'); ?>">
                                        <?php else: ?>
                                            <input type="button" value="Edit Contact"
                                                class="btn btn-primary editContact project-create-continue"
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12 formTable">
                            ...
                            <div class="job-info-panel-input-wrapper">
                                ...
                                <input type="text" name="job_city" disabled value="<?php echo e($project ? $project->city : ''); ?>">
                            </div>
                            <div class="job-info-panel-input-wrapper">
                            ...
                            <div class="job-info-panel-input-wrapper">
                                ...
                                <input type="text" name="job_zip" disabled value="<?php echo e($project ? $project->zip : ''); ?>">
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-12 formTable"
                            style="display: <?php echo e(isset($jobInfoSheet) && $jobInfoSheet != '' && $jobInfoSheet->status == '2' ? 'block' : 'block'); ?>;">
                            <div class="job-info-panel-input-wrapper">
                                ...
                                <input type="text" name="county" disabled value="<?php echo e($project ? $project->county : ''); ?>">
                            </div>
                        ...
                        <div class="col-md-6 formTable contractInformation job-info-panel--label">
                            ...
                            <div class="col-sm-6 no-padding">
                                <input type="text" id="revisedTotal" name="revisedTotal"
                                    ...
                                    data-contract="<?php echo e($contractCreated); ?>" disabled>
                            </div>
                            <div class="col-sm-6 no-padding">
                            ...
                            <div class="col-sm-6 no-padding">
                                <input type="text" id="job_no" name="job_no"
                                    value="<?php echo e(isset($contract->job_no) && !empty($contract->job_no) ? $contract->job_no : '0'); ?>"
                                    data-contract="<?php echo e($contractCreated); ?>" disabled>
                            </div>
                            ...
                            <div class="col-sm-6 no-padding">
                                <textarea style="width:100%" type="text" id="general_description" name="general_description"
                                    value="" data-contract="<?php echo e($contractCreated); ?>"
                                    disabled><?php echo e(isset($contract->general_description) && !empty($contract->general_description) ? $contract->general_description : ''); ?></textarea>
                            </div>
                        </div>
                ...
                <div class="table-responsive">
                    <div class="black-box-main">
                        ...
                        <div class="row footerTxt">
                            <?php if(isset($lienProvider) && !empty($lienProvider->logo)): ?>
                                <div style="text-align:center; "><img src="/liens/<?php echo e($lienProvider->logo); ?>" alt="NLB" align="middle"></div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 field mobile--agree">
                                <label><input type="checkbox" name="Agree" id="agree"
                                        ...
                                        <?php echo e(isset($jobInfoSheet) && $jobInfoSheet != '' && $jobInfoSheet->status == '2' ? 'disabled1' : ''); ?>>
                                    &nbsp;By submitting this
...
<?php echo $__env->make('basicUser.projects.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/lienmanager/public_html/resources/views/basicUser/document/owner_notice_sheet.blade.php ENDPATH**/ ?>