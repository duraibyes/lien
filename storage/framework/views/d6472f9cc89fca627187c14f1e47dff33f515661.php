            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="border-table">
                        ...
                        <input type="text" name="job_name" value="<?php echo e($project ? $project->project_name : ''); ?>"
                    ...
                    <div class="border-table">
                        ...
                        <input type="text" id="job_city" name="job_city" value="<?php echo e($project ? $project->city : ''); ?>"
                            class="search-construction form-control input-field">
                    </div>
                    <div class="border-table">
                        ...
                        <select name="job_state" id="job_state" class="form-control input-field" disabled>
                            ...
                            <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($state->id); ?>"
                                    <?php echo e($project->state_id == $state->id ? 'selected' : ''); ?>><?php echo e($state->name); ?>
                    ...
                    <div class="border-table">
                        ...
                        <input type="text" id="job_zip" name="job_zip" value="<?php echo e($project ? $project->zip : ''); ?>"
                            class="search-construction form-control input-field">
                    </div>

                    <div class="border-table">
                        <label for="county">County</label>
                        <input type="text" id="job_county" name="county" value="<?php echo e($project ? $project->county : ''); ?>"
                            class="search-construction form-control input-field">
                    </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        function initialize() {
            ...
            autocomplete.addListener('place_changed', function() {
                ...
                if ("<?php echo $project->state->name; ?>" != state) {
                    alert("You can only choose address in " + "<?php echo $project->state->name; ?>" + "! " + state +
                        " is selected!");
                    $('#job_address').val('');
                    return;
                }
    ...
    <script>
        ...
        let saveJobDescription = "<?php echo e(route('edit.job.description', [$project_id])); ?>"
        let contactURL = "<?php echo e($contactURL); ?>"
...
<?php echo $__env->make('basicUser.projects.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/lienmanager/public_html/resources/views/basicUser/projects/job_description.blade.php ENDPATH**/ ?>