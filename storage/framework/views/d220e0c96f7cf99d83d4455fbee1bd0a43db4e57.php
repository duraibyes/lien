                                ...
                                <?php if(count($contacts) > 0): ?>
                                    <?php $__currentLoopData = $contacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <?php if(isset($contact->user)): ?>
                                                <td> <?php echo e($contact->user->user_name); ?> </td>
                                                <td> <?php echo e($contact->user->email); ?> </td>
                                            <?php else: ?>
                                                <td></td>
                                                <td></td>
                                            <?php endif; ?>
                                            ...
                                            <td>
                                                <?php if(isset($contact->user)): ?>
                                                    <a href="<?php echo e(route('reply.contact.us', [$contact->id])); ?>"
                                                       class="btn btn-info btn-xs" title="Send Mail">
                                                        <i class="fa fa-send"></i>
                                                    </a>
                                                <?php endif; ?>
                                                <button class="btn btn-danger btn-xs delete" type="button"
                                                        data-id="<?php echo e($contact->id); ?>" title="Delete user">
        ...
        $(document).ready(function() {
            $('.delete').on('click', function() {
                ...
                swal({
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(route('contact.us.delete')); ?>",
                        data: {
                            id: id,
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/lienmanager/public_html/resources/views/admin/contact/contact.blade.php ENDPATH**/ ?>