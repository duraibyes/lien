...
<?php $__env->startSection('title', 'Remedy Steps'); ?>
<!-- Main Content -->
                        ...
                        <div class="main-tab-sec">
                            ...
                            <div class="tab-content tab-final">
                                <div id="public" class="tab-pane fade in active">
                                    <form method="post" action="<?php echo e(route('remedy.hide.remedy_steps')); ?>">
                                        ...
                                        <div class="box-body table-responsive no-padding">
                                            <table class="table table-striped">
                                                ...
                                                <?php if(count($remedySteps) > 0): ?>
                                                    <?php $__currentLoopData = $remedySteps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $remedyStep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td><input type="checkbox" name="hideRemedySteps[]"
                                                                    value="<?php echo e($remedyStep->id); ?>" class="remstep"></td>
                                                            <td><?php echo e($key + 1); ?></td>
                                                            <td><?php echo e($remedyStep->getRemedy->state->name . ' / ' . $remedyStep->getRemedy->type->project_type . ' / ' . $remedyStep->getRemedy->remedy); ?>

                                                            </td>
                                                            <td><?php echo e($remedyStep->remedy_date->date_name); ?></td>
                                                            <td><?php echo e($remedyStep->short_description); ?></td>
                                                            <td><?php echo e($remedyStep->long_description); ?></td>
                                                            <td><?php echo e($remedyStep->years); ?></td>
                                                            <td><?php echo e($remedyStep->months); ?></td>
                                                            <td><?php echo e($remedyStep->days); ?></td>
                                                            <td><?php echo e($remedyStep->day_of_month); ?></td>
                                                            <td>
                                                                <?php echo e($remedyStep->notes); ?>
                                        ...
                                        <div>
                                            ...
                                            <div class="box-footer clearfix">
                                                <ul class="pagination pagination-sm no-margin pull-right">
                                                    <?php echo e($remedySteps->appends(request()->query())->links()); ?>
                                ...
                                <div id="private" class="tab-pane fade">
                                    <form method="post" action="<?php echo e(route('remedy.hide.remedy_steps_private')); ?>">
                                        <?php echo e(csrf_field()); ?>
                                        ...
                                        <div class="box-body table-responsive no-padding">
                                            <table class="table table-striped">
                                                ...
                                                <?php if(count($remedyStepPrivate) > 0): ?>
                                                    <?php $__currentLoopData = $remedyStepPrivate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $remedyStep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td><input type="checkbox" name="hideRemedySteps[]"
                                                                    value="<?php echo e($remedyStep->id); ?>" class="remstep_private">
                                                            </td>
                                                            <td><?php echo e($key + 1); ?></td>
                                                            <td><?php echo e($remedyStep->getRemedy->state->name . ' / ' . $remedyStep->getRemedy->type->project_type . ' / ' . $remedyStep->getRemedy->remedy); ?>
                                        ...
                                        <div>
                                            ...
                                            <div class="box-footer clearfix">
                                                <ul class="pagination pagination-sm no-margin pull-right">
                                                    <?php echo e($remedyStepPrivate->appends(request()->query())->links()); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/lienmanager/public_html/resources/views/remedy/remedy_step.blade.php ENDPATH**/ ?>