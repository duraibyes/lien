...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(env('ASSET_URL')); ?>/css/login.css">
...
-->
    ...
    <!-- jQuery 3 -->
    <script src="<?php echo e(env('ASSET_URL')); ?>/admin_assets/bower_components/jquery/dist/jquery.min.js"></script>
    <!-- jQuery UI 1.11.4 -->
...
<?php /**PATH /home2/lienmanager/public_html/resources/views/user/main.blade.php ENDPATH**/ ?>