...
<?php $__env->startSection('title', 'Sub User'); ?>
<!-- Main Content -->
                                ...
                                <?php if(count($users) > 0): ?>
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e(!is_null($user->mapcompanyContacts) && !is_null($user->mapcompanyContacts->company) ? $user->mapcompanyContacts->company->company : 'N/A'); ?>

                                            </td>
                                            <td><?php echo e(!is_null($user->mapcompanyContacts) && !is_null($user->mapcompanyContacts->phone) ? $user->mapcompanyContacts->phone : 'N/A'); ?>

                                            </td>
                                            <td><?php echo e($user->name); ?></td>
                                            <td><?php echo e($user->user_name); ?></td>
                                            <td><?php echo e(!is_null($user->details) && !is_null($user->details->company) ? $user->details->phone : 'N/A'); ?>
                                            ...
                                            <td>
                                                <button class="btn btn-info btn-xs" data-type="Edit" type="button"
                                                    title="Edit user">
                                                    <a href="<?php echo e(route('user.sub.edit', ['id' => $user->id])); ?>"><i
                                                            class="fa fa-pencil"></i></a>
                                                </button>
                                                <button class="btn btn-warning btn-xs lock" data-id="<?php echo e($user->id); ?>"
                                                    data-status="<?php echo e($user->status); ?>" type="button"
                                                    title="Change password"><i
                                                        class="fa fa-<?php echo e($user->status == '0' ? 'unlock' : 'lock'); ?>"></i></button>
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control error" name="member" id="member">
                                        ...
                                        <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($member->id); ?>"><?php echo e($member->email); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#addSubButton').on('click', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('user.add.sub')); ?>",
                    data: {
                        type: type,
                        member: member,
                        fname: fname,
        ...
        $('#member').change(function() {
            ...
            if (member_id != '') {
                $.ajax({
                    url: "<?php echo e(route('admin.subuser.companydetails')); ?>",
                    dataType: "json",
                    data: {
                        member_id: member_id,
                        _token: '<?php echo e(csrf_token()); ?>'
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/lienmanager/public_html/resources/views/admin/subUser/list.blade.php ENDPATH**/ ?>