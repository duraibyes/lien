                    ...
                    <div class="box">
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-striped">
                                ...
                                <?php if(count($remedies) > 0): ?>
                                    <?php $__currentLoopData = $remedies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $remedy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($key + 1); ?></td>
                                            <td><?php echo e($remedy->state->name); ?></td>
                                            <td><?php echo e($remedy->type->project_type); ?></td>
                                            <td>
                                                <?php echo e($remedy->remedy); ?>
                        ...
                        <div class="box-footer clearfix">
                            <ul class="pagination pagination-sm no-margin pull-right">
                                ...
                                <?php echo e($remedies->appends(Request::except('page'))->links()); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/lienmanager/public_html/resources/views/remedy/remedy.blade.php ENDPATH**/ ?>