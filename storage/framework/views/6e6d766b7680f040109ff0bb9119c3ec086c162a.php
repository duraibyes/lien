...
<?php $__env->startSection('title', 'Project roles & types'); ?>
                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="box-body table-responsive no-padding">
                                <form method="post" action="<?php echo e(route('project.upload.excel')); ?>"
                                    ...
                                    <div class="box-tools">
                                        <div class="input-group input-group-sm" style="width: 150px;">
                                            <input type="text" id="role_search"
                                                value="<?php echo e(isset($_GET['projectRole']) && $_GET['projectRole'] != '' ? $_GET['projectRole'] : ''); ?>"
                                        ...
                                        <?php if(count($roles) > 0): ?>
                                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($role->project_roles); ?></td>
                                                    <td>
                                                        <button class="btn btn-info btn-xs addProjectButton" type="button"
                                                            data-type="Edit project role"
                                                            data-name="<?php echo e($role->project_roles); ?>"
                                                            data-id="<?php echo e($role->id); ?>" title="Edit role"><i
                                                                class="fa fa-pencil"></i></button>
                                                        <button class="btn btn-danger btn-xs delete" data-type="role"
                                                            data-id="<?php echo e($role->id); ?>" type="button"
                                    ...
                                    <div class="box-tools">
                                        <div class="input-group input-group-sm" style="width: 150px;">
                                            <input type="text" id="type_search"
                                                value="<?php echo e(isset($_GET['projectType']) && $_GET['projectType'] != '' ? $_GET['projectType'] : ''); ?>"
                                                class="form-control pull-right" placeholder="Search">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <?php if(count($types) > 0): ?>
                                            <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e($key + 1); ?></td>
                                                    <td><?php echo e($type->project_type); ?></td>
                                                    <td>
                                                        <button class="btn btn-info btn-xs addProjectButton" type="button"
                                                            data-type="Edit project type"
                                                            data-name="<?php echo e($type->project_type); ?>"
                                                            data-id="<?php echo e($type->id); ?>" title="Edit Type"><i
                                                                class="fa fa-pencil"></i></button>
                                                        <button class="btn btn-danger btn-xs delete"
                                                            data-id="<?php echo e($type->id); ?>" data-type="type" type="button"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#addButton').on('click', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('project.management.action')); ?>",
                    data: {
                        id: id,
                        type: type,
                        name: name,
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/lienmanager/public_html/resources/views/project/management.blade.php ENDPATH**/ ?>