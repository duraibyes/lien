                                ...
                                <?php if(count($users) > 0): ?>
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e(!is_null($user->details) && !is_null($user->details->getCompany) && !is_null($user->details->getCompany->company) ? $user->details->getCompany->company : 'N/A'); ?>

                                            </td>
                                            <td><?php echo e(!is_null($user->details) && !is_null($user->details->getCompany) && !is_null($user->details->getCompany->phone) ? $user->details->getCompany->phone : 'N/A'); ?>

                                            </td>
                                            <td><?php echo e($user->name); ?></td>
                                            <td><?php echo e($user->user_name); ?></td>
                                            <td><?php echo e(!is_null($user->details) && !is_null($user->details->phone) ? $user->details->phone : 'N/A'); ?>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                <?php if(empty($lienProviderArray)): ?>
                                                    NLB
                                                <?php else: ?>
                                            ...
                                            <td>
                                                <input type="checkbox" class="status" data-id="<?php echo e($user->id); ?>"
                                                    data-status="<?php echo e($user->status); ?>"
                                                    <?php echo e($user->status == '0' ? 'checked' : ''); ?> data-toggle="toggle"
                                                    data-on="Active" data-off="Inactive" data-onstyle="success"
                                                    data-offstyle="danger">
                                            </td>
                                            <td>
                                                <button class="btn btn-info btn-xs editMember"
                                                    data-id="<?php echo e($user->id); ?>" data-type="Edit" type="button"
                                                    data-toggle="modal"><i class="fa fa-pencil"></i></button>
                                                <!-- <a class="btn btn-info btn-xs" href="<?php echo e(route('user.member.edit', ['id' => $user->id])); ?>"><i class="fa fa-pencil"></i></a> -->
                                                <button class="btn btn-danger btn-xs delete" data-id="<?php echo e($user->id); ?>"
                                    ...
                                    <select name="lienProviders[]" id="lienProviders" multiple
                                        ...
                                        <?php if(count($lienProviders)): ?>
                                            <?php $__currentLoopData = $lienProviders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $provider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option class=".lienProVal" value="<?php echo e($provider->id); ?>">
                                                    <?php echo e($provider->firstName . ' ' . $provider->lastName . '( ' . $provider->company . ' )'); ?>
                                        ...
                                        <?php if(isset($packages)): ?>
                                            <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($package->id); ?>"
                                                    data-multiple="<?php echo e($package->is_multiple); ?>"><?php echo e($package->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php endif; ?>
                                    </select>
                                </div>
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        function getMaxPrice(value) {
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('package.get.maxPrice')); ?>",
                data: {
                    id: value,
        ...
        $('#packageState').change(function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(route('package.state.autopopulate')); ?>",
                data: {
                    ids: ids,
                    _token: '<?php echo e(csrf_token()); ?>'
                },
        ...
        $(document).delegate('.cancelSub', 'click', function() {
            ...
            swal({
                ...
                $.ajax({
                    type: "POST",
                    url: '<?php echo e(route('cancel.subscription')); ?>',
                    data: {
                        user_id: user_id,
                        _token: '<?php echo e(csrf_token()); ?>'
                    },
        ...
        $(document).ready(function() {
            ...
            $('#addMemberButton').on('click', function() {
                ...
                if (editMode == 0) {
                    ...
                    var url = "<?php echo e(route('user.add.member')); ?>";
                    var data = {
                        type: type,
                        fname: fname,
                        lname: lname,
                    ...
                    var triggerPayment = $('#triggerPayment').is(':checked');
                    var url = "<?php echo e(route('user.member.edit.model.action')); ?>";
                    var data = {
                        user_id: $('#user_id').val(),
                        type: type,
                        fname: fname,
            ...
            $('.delete').on('click', function() {
                ...
                swal({
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(route('member.delete')); ?>",
                        data: {
                            id: id,
                            _token: "<?php echo e(csrf_token()); ?>"
                        },
        ...
        $('.editMember').on('click', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('user.member.edit.modal')); ?>",
                // dataType: "json",
                data: {
                    memberID: memberID,
                    _token: '<?php echo e(csrf_token()); ?>'
        ...
        //
        //   $.ajax({
        //       url: "<?php echo e(route('user.member.edit.model.action')); ?>",
        //       type: 'POST',
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/lienmanager/public_html/resources/views/member/member.blade.php ENDPATH**/ ?>