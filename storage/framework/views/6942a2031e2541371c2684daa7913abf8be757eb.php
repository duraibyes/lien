            ...
            <?php if(count($deadlines) > 0): ?>
                <?php $__currentLoopData = $deadlines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $deadline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-12 deadlines" style="display:flex;justify-content:center;gap:60px;">
                        ...
                        <div style="margin-bottom:10px"><b><?php echo e($deadline->getRemedy->remedy); ?></b></div>
                                                 <div>
                                                    <?php if(strlen($daysRemain[$key]['preliminaryDates']) > 5): ?>
                                    ...
                                    <div style="display:flex;flex-direction:column;">
                                                <div>
                                                    <p><?php echo e($deadline->short_description); ?></p>
                                                </div>
                                                <div>
                                                    <?php if(strlen($daysRemain[$key]['preliminaryDates']) > 5): ?>
                                                        <?php if($late === '+'): ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#saveDeadlines', function(event) {
                ...
                window.location.href = "<?php echo e(route('project.task.view', $project->id) . '?edit=true'); ?>";
            });
        })
...
<?php echo $__env->make('basicUser.projects.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/lienmanager/public_html/resources/views/basicUser/projects/viewdeadlines.blade.php ENDPATH**/ ?>