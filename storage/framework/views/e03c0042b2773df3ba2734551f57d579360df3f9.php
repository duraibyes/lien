                    ...
                    <td>
                        ...
                        <select class="form-control chosen" name="job_info_status">
                            ...
                            <option value="1" <?php if(isset($queryParams) && array_key_exists('jobinfoStatus', $queryParams) && $queryParams['jobinfoStatus'] == '1'): ?>
                                ...
                                <?php endif; ?>
                                >Active</option>
                            <option value="2" <?php if(isset($queryParams) && array_key_exists('jobinfoStatus', $queryParams) && $queryParams['jobinfoStatus'] == '2'): ?>
                                <?php echo e('selected'); ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <select class="form-control chosen" name="user">
                            <option value="all" <?php if(isset($queryParams) && array_key_exists('user', $queryParams) && $queryParams['user'] == 'all'): ?>
                                <?php echo e('selected'); ?>
                            ...
                            <?php if(isset($subUsers)): ?>
                                <?php $__empty_1 = true; $__currentLoopData = $subUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $subUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <option value="<?php echo e($key); ?>" <?php if(isset($queryParams) && array_key_exists('user', $queryParams) && $queryParams['user'] == $key): ?>
                                        <?php echo e('selected'); ?>
                    ...
                    <td>
                        ...
                        <select class="form-control chosen" name="date_type">
                            <option value="all" <?php if(isset($queryParams) && array_key_exists('dateType', $queryParams) && $queryParams['dateType'] == 'all'): ?>
                                ...
                                <?php endif; ?>
                                >All</option>
                            <option value="EntryDate" <?php if(isset($queryParams) && array_key_exists('dateType', $queryParams) && $queryParams['dateType'] == 'EntryDate'): ?>
                                <?php echo e('selected'); ?>

                                    <?php endif; ?>
                            >Entry Date</option>
                            <option value="NextActionDate" <?php if(isset($queryParams) && array_key_exists('dateType', $queryParams) && $queryParams['dateType'] == 'NextActionDate'): ?>
                                <?php echo e('selected'); ?>
...
<?php /**PATH /home2/lienmanager/public_html/resources/views/project/project_list_filter_admin.blade.php ENDPATH**/ ?>