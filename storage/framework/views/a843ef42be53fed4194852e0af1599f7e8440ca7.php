...
<?php $__env->startSection('title', 'Lien Provider'); ?>
<!-- Main Content -->
                    ...
                    <div class="box">
                        <div class="box-header">
                            <div class="row col-md-12">
                                ...
                                <div class="col-md-4 input-group input-group pull-right">
                                    <input id="tier_search" value="<?php echo e(isset($_GET['search']) ? $_GET['search'] : ''); ?>"
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <?php if(count($lienProviders)): ?>
                                    <?php $__currentLoopData = $lienProviders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $provider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($key + 1); ?></td>
                                            <td><?php echo e($provider->company); ?></td>
                                            <td><?php echo e(!is_null($provider->companyPhone) && !empty($provider->companyPhone) ? $provider->companyPhone : 'N/A'); ?>

                                            </td>
                                            <td><?php echo e($provider->firstName); ?></td>
                                            <td><?php echo e($provider->lastName); ?></td>
                                            <td><?php echo e(!is_null($provider->phone) && !empty($provider->phone) ? $provider->phone : 'N/A'); ?>

                                            </td>
                                            <td><?php echo e($provider->email); ?></td>
                                            <?php if(isset($provider->states) && count($provider->states) > 0): ?>
                                                <td>
                                                    <?php $__currentLoopData = $provider->states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skey => $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php $__currentLoopData = $state->state; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sskey => $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php echo e($st->name); ?>
                                            ...
                                            <?php else: ?>
                                                <td><?php echo e($provider->state->name); ?></td>
                                            <?php endif; ?>

                                            <td>
                                                <button class="btn btn-info btn-xs subUser" data-type="Edit"
                                                    data-id="<?php echo e($provider->id); ?>"
                                                    data-company_id="<?php echo e($provider->company_id); ?>"
                                                    data-user_id="<?php echo e($provider->user_id); ?>"
                                                    data-company="<?php echo e($provider->company); ?>"
                                                    data-role_name="<?php echo e($provider->role_name); ?>"
                                                    data-role_other="<?php echo e($provider->role_other); ?>"
                                                    data-companyphone="<?php echo e($provider->companyPhone); ?>"
                                                    data-fname="<?php echo e($provider->firstName); ?>"
                                                    data-logo="<?php echo e($provider->logo); ?>"
                                                    data-lname="<?php echo e($provider->lastName); ?>"
                                                    data-email="<?php echo e($provider->email); ?>"
                                                    data-phone="<?php echo e($provider->phone); ?>"
                                                    data-fax="<?php echo e($provider->fax); ?>"
                                                    <?php if(isset($provider->states) && count($provider->states) > 0): ?>
                                                        data-state="<?php echo e($provider->states); ?>"
                                                    <?php else: ?>
                                                        data-state="<?php echo e($provider->stateId); ?>"
                                                    <?php endif; ?>
                                                    data-address="<?php echo e($provider->address); ?>"

                                                    data-zip="<?php echo e($provider->zip); ?>" data-city="<?php echo e($provider->city); ?>"
                                                    type="button" title="Edit user">
                                                    <a href="#"><i class="fa fa-pencil"></i></a>
                                                </button>
                                                <?php if($provider->is_deletable == '1'): ?>
                                                    <button class="btn btn-danger btn-xs delete"
                                                        data-id="<?php echo e($provider->id); ?>" type="button" title="Delete lien">
                        ...
                        <div class="box-footer clearfix">
                            <ul class="pagination pagination-sm no-margin pull-right">
                                <?php echo e($lienProviders->links()); ?>
            ...
            .change(
                function() {
                    if ($(this).val() != "new_data") {
                        $.ajax({
                            url: '<?php echo e(route('admin.company.autocomplete')); ?>',
                            dataType: "json",
                            data: {
                                key: $(this).val(),
        ...
        $(document).ready(function() {
            ...
            $('.delete').on('click', function() {
                ...
                swal({
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(route('lien.delete')); ?>",
                        data: {
                            id: id,
                            _token: "<?php echo e(csrf_token()); ?>"
                        },
            ...
            $('#addSubButton').on('click', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('add.lien.provider')); ?>",
                    cache: false,
                    contentType: false,
                    processData: false,
                    data: formData,
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/lienmanager/public_html/resources/views/admin/lien/lien_list.blade.php ENDPATH**/ ?>